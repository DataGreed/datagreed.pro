...
img: /assets/img/projects/listenable.png
importance: 1
---
...
todo: would be great to add a distill-like header with platform, type (education service), time period, my role, platforms, etc.
...
todo: analytics, etc. programming when bootstrapping without any funding.
